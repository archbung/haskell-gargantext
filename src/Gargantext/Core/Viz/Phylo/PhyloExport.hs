...
import Data.Map (fromList, empty, fromListWith, insert, (!), elems, unionWith, findWithDefault, member, toList)
...
dotToFile filePath dotG = writeFile filePath $ Text.pack $ dotToString dotG
